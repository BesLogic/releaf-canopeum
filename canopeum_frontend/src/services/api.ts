        ...
        if (resultData200) {
          ...
          for (let key in resultData200) {
            if (resultData200.hasOwnProperty(key)) {
              ;(<any> result200)![key] = resultData200[key] !== undefined
                ? resultData200[key]
                : <any> null
            }
          }
...
export class SiteAdminsClient {
  ...
  all(): Promise<SiteAdmins[]> {
    let url_ = this.baseUrl + '/site-admins/'
    url_ = url_.replace(/[?&]$/, '')
  ...
  protected processAll(response: Response): Promise<SiteAdmins[]> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => _headers[k] = v)
    ...
    if (status === 200) {
      return response.text().then(_responseText => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any
          for (let item of resultData200) {
            result200!.push(SiteAdmins.fromJS(item))
          }
        } else {
          result200 = <any> null
        }
    ...
    return Promise.resolve<SiteAdmins[]>(null as any)
  }
}
...
export class SocialClient {
  ...
  ): Promise<UpdateSitePublicStatus> {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.changePassword = _data['changePassword']
        ? ChangePassword.fromJS(_data['changePassword'])
        : <any> undefined
    }
  }
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.announcement = _data['announcement']
        ? Announcement.fromJS(_data['announcement'])
        : new Announcement()
...
export class SiteAdminSiteInfo implements ISiteAdminSiteInfo {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      ;(<any> this).id = _data['id']
      this.name = _data['name']
      this.siteType = _data['siteType']
    }
  }

  static fromJS(data: any): SiteAdminSiteInfo {
    data = typeof data === 'object' ? data : {}
    let result = new SiteAdminSiteInfo()
    result.init(data)
    return result
  }
...
export interface ISiteAdminSiteInfo {
  id: number
  name: string
  siteType?: number | undefined
    ...
    if (_data) {
      ...
      if (Array.isArray(_data['sites'])) {
        ...
        for (let item of _data['sites']) {
          ;(<any> this).sites!.push(SiteAdminSiteInfo.fromJS(item))
        }
      }
    }
  }

  static fromJS(data: any): SiteAdmins {
    data = typeof data === 'object' ? data : {}
    let result = new SiteAdmins()
    result.init(data)
    return result
  }
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.lastLogin = _data['lastLogin']
        ? new Date(_data['lastLogin'].toString())
        : <any> undefined
      ...
      this.dateJoined = _data['dateJoined']
        ? new Date(_data['dateJoined'].toString())
        : <any> undefined
      this.email = _data['email']
