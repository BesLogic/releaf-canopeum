...
export class SiteClient {
  ...
  create(name: string | undefined, siteType: number | null | undefined, image: FileParameter | undefined, latitude: string | undefined, longitude: string | undefined, description: string | undefined, size: number | undefined, species: Species2[] | undefined, researchPartnership: boolean | undefined, visibleMap: boolean | undefined): Promise<Site> {
      let url_ = this.baseUrl + "/analytics/sites/";
      url_ = url_.replace(/[?&]$/, "");
