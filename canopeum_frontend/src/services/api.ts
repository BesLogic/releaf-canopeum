...
export class BatchClient {
    ...
    protected processAll(response: Response): Promise<BatchDetail[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<BatchDetail[]>(null as any);
    }

    create(site?: number | undefined, name?: string | null | undefined, sponsor?: string | null | undefined, size?: number | null | undefined, soilCondition?: string | null | undefined, plantCount?: number | null | undefined, survivedCount?: number | null | undefined, replaceCount?: number | null | undefined, totalNumberSeed?: number | null | undefined, totalPropagation?: number | null | undefined, image?: FileParameter | null | undefined, fertilizerIds?: number[] | undefined, mulchLayerIds?: number[] | undefined, seeds?: Seeds[] | undefined, species?: Species[] | undefined, supportedSpecieIds?: number[] | undefined): Promise<BatchDetail> {
        let url_ = this.baseUrl + "/analytics/batches/";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: Response): Promise<BatchDetail> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 201) {
            return response.text().then((_responseText) => {
    ...
    update(batchId: number, name?: string | null | undefined, sponsor?: string | null | undefined, size?: number | null | undefined, soilCondition?: string | null | undefined, plantCount?: number | null | undefined, survivedCount?: number | null | undefined, replaceCount?: number | null | undefined, totalNumberSeed?: number | null | undefined, totalPropagation?: number | null | undefined, fertilizerIds?: number[] | undefined, mulchLayerIds?: number[] | undefined, seeds?: Seeds2[] | undefined, species?: Species2[] | undefined, supportedSpecieIds?: number[] | undefined): Promise<BatchDetail> {
    ...
    protected processUpdate(response: Response): Promise<BatchDetail> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class SiteClient {
    ...
    create(name?: string | undefined, siteType?: number | undefined, image?: FileParameter | undefined, latitude?: string | undefined, longitude?: string | undefined, description?: string | undefined, size?: number | undefined, species?: Species3[] | undefined, researchPartnership?: boolean | undefined, visibleMap?: boolean | undefined): Promise<Site> {
        let url_ = this.baseUrl + "/analytics/sites/";
        url_ = url_.replace(/[?&]$/, "");
...
export class ContactClient {
    ...
    update(contactId: number, body?: PatchedContact | undefined): Promise<Contact> {
...
export class PostClient {
    ...
    all(page: number, size: number, siteId?: number[] | undefined): Promise<PostPagination> {
...
export class LikeClient {
    ...
    protected processLikePost(response: Response): Promise<Like> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 201) {
            return response.text().then((_responseText) => {
    ...
    delete(postId: number): Promise<Like> {
        let url_ = this.baseUrl + "/social/posts/{postId}/likes/";
        if (postId === undefined || postId === null)
            throw new Error("The parameter 'postId' must be defined.");
        url_ = url_.replace("{postId}", encodeURIComponent("" + postId));
    ...
    protected processDelete(response: Response): Promise<Like> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 201) {
            return response.text().then((_responseText) => {
...
export class Seeds2 implements ISeeds2 {
    ...
    static fromJS(data: any): Seeds2 {
        data = typeof data === 'object' ? data : {};
        let result = new Seeds2();
        result.init(data);
        return result;
    }
...
export class Species4 implements ISpecies4 {
    ...
    static fromJS(data: any): Species4 {
        data = typeof data === 'object' ? data : {};
        let result = new Species4();
        result.init(data);
        return result;
    }
