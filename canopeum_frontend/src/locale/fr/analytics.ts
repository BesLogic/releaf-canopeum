...
export default {
  ...
  'site-modal': {
    ...
    validation: {
      ...
      'image-required': "L'image de site est requise",
      'file-size-exceeds': 'La taille du fichier dépasse 2 Mo',
      'tree-species-required': 'Le site doit contenir au moins un arbre',
      ...
      'site-type-required': 'Le type de site est requis',
      'character-number-exceed': 'Le nombre maximal de charactère est dépassé',
    },
  },
