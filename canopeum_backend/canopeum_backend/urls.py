...
urlpatterns = [
    ...
    path('social/posts/<int:postId>/comments/<int:commentId>/', views.CommentDetailAPIView.as_view(), name='comment-detail'),
    ...
    # Announcement
    path('social/sites/<int:siteId>/announcements/', views.AnnouncementDetailAPIView.as_view(), name='announcement-detail'),

    # Contact
    path('social/sites/<int:siteId>/contacts/<int:contactId>/', views.ContactDetailAPIView.as_view(), name='contact-detail'),

    # Widget
    path('social/sites/<int:siteId>/widgets/', views.WidgetListAPIView.as_view(), name='widget-list'),
    path('social/sites/<int:siteId>/widgets/<int:widgetId>/', views.WidgetDetailAPIView.as_view(), name='widget-detail'),
